...
// Intercambia 2 valores del arreglo
fun swap(A: Array<Int>, i: Int, j: Int): Unit {
 ...
 //Creamos el procedimiento Max
 //Calcula el maximo elemento en un arreglo

 fun calcMax(A:Array<Int>): Int {
...
//Creamos el procedimiento numeroDeDigitos
// Devuelve el numero de digitos no negativo de un entero

fun numeroDeDigitos(n: Int): Int {
    var digitos: Int = 0;
    var num: Int = n;
    while (num > 0) {
        num /= 10;
...
// Pre: A un arreglo de enteros, p y r enteros
// Post: Devuelve el arreglo A ordenado
...
// Pre: A un arreglo de enteros
// Post: Devuelves el arreglo A ordenado
...
// Pre: A un arreglo de enteros
// Post: Realiza el procedimiento quicksort con 3 particiones y devuelve el arreglo ordenado
...
// Pre: A es un arreglo de enteros
// Post: Realiza QuickSort con 2 pivotes y devuelve el arreglo ordenado
...
// Pre: A es un arreglo de enteros, left y right son enteros
// Post: Realiza QuickSort con 2 pivotes y devuelve el arreglo ordenado
fun dualPivotAux(A:Array<Int>, left:Int, right:Int){
    ...
    //Creamos el procedimiento CountingSortAux
    // Pre: A y B arreglos de enteros, k un entero
    // Post: Devuelve el arreglo A ordenado
    fun countingSortAux(A: Array<Int>, B: IntArray, k: Int) {
        val n = A.size;
    ...
    //Creamos el procedimiento countingSort
    // Pre: A un arreglo de enteros
    // Post: Devuelve el arreglo A ordenado usando CountingSort
    fun countingSort(A: Array<Int>) {
        val k = calcMax(A);
        val B = IntArray(A.size);
        countingSortAux(A, B, k);
    }

    //Creamos el procedimiento radixSortAux
    // Pre: A un arreglo de enteros y d un entero
    // Post: Ordena el arreglo por digitos y devuelve el arreglo ordenado 
    fun radixSortAux(A:Array<Int>, d: Int){
        val n = A.size;
        val B = IntArray(n);
        for (i in 1..d) {
            val C = IntArray(10);
    ...
    //Creamos el procedimiento radixSort
    // Pre: A un arreglo de enteros
    // Post: Devuelve el arreglo ordenado implementando radixSort
    fun radixSort(A:Array<Int>){
        val d = numeroDeDigitos(calcMax(A));
        radixSortAux(A,d);
    }